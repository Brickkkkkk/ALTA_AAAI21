...
def load_datasets(dataset_name, dataset_dir, do_pca, pca_dims, add_bias, remove_mean, density_sigma, interp_sigma, dist_sigma):
    print(dataset_name)
    ...
    #distance of points
    dataset_train['X_distance'] = ut.compute_distance(dataset_train['X'], dataset_train['Y'], dist_sigma, True)
...
def load_data(dataset_dir, dataset_name, interp_sigma):
    ...
    if 'interp' not in list(data.keys()):
